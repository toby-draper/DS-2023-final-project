...
For this project, I used python code to transform raw data from a csv into a visually appealing infographic that displays the distribution of musical keys across various music genres. The infographic gives context to what a musical key is the role they play in composition, and provides potential explanations for the trends observed. The dataset comes from Kaggle and contains just over 10,000 unique tracks drawn from the author's Spotify listening history in 2022.
